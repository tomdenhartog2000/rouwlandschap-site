...
type ManagedContribution = { id: string; title: string; description: string; kind: string; text: string; reference: string; referenceLink: string; sharing: "online" | "here" | "future"; status: "visible" | "hidden"; createdAt: number; attachments: Attachment[] };
