...
export default function MaakEenRouwdier() {
  ...
  return (
    <main className="make-page">
      <header className="make-header"><a href="/verken" className="back-link">← terug naar het landschap</a></header>
      <section className="make-card" aria-live="polite">
        ...
        {step === 5 && <div className="make-intro completion">
          ...
          <a className="primary-button link-button" href="/verken">terug naar het landschap</a>
        </div>}
      </section>
    </main>
  );
