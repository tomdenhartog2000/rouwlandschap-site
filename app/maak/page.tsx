...
export default function MaakEenRouwdier() {
  ...
  const playLiveDrawingSound = (point: { x: number; y: number }) => {
    if (!liveDrawingSound || Date.now() - lastLiveSoundAt.current < 320) return;
