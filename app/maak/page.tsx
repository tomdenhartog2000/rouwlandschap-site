...
const formNames: Record<AiForm, string> = { image: "beeld", text: "woorden", motion: "beweging" };
...
export default function MaakEenRouwdier() {
  ...
  useEffect(() => {
    if (step === 21 && aiFormsSelected[0] && aiFormsSelected[0] !== "image") setStep(22);
  }, [aiFormsSelected, step]);
