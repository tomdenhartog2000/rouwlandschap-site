  ...
  return (
    <main className="information-page">
      <article className="information-card project-information-card">
        ...
        <p className="information-source"><Link className="primary-button" href="/verken?kijk=1">bekijk het online landschap</Link></p>
        <p className="information-source"><Link href="/over-ai">Lees over AI en je bijdrage</Link></p>
      </article>
    </main>
  );
}
