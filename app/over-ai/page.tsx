    ...
    <main className="information-page">
      <article className="information-card">
        ...
        <section>
          ...
          <p>Alleen wanneer je aan het eind kiest om je rouwdier online te laten leven, wordt het bewaard. Andere bezoekers kunnen het dan in het online landschap openen.</p>
          ...
          <p>De bijdrage blijft bewaard als onderdeel van dit project. De maker kan bijdragen verbergen of verwijderen wanneer dat nodig is.</p>
        </section>
