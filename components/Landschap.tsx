...
export default function Landschap() {
  ...
  const openContributionVisuals = openContribution ? [
    ...(openContribution.images?.length ? openContribution.images : openContribution.image ? [openContribution.image] : []),
    ...(openContribution.drawing && !openContribution.images?.includes(openContribution.drawing) ? [openContribution.drawing] : []),
  ] : [];
